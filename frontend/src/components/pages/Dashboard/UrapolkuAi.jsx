      ...
      <div className="Card-content">
        <div className="Career">
          ...
          <div className="Career-text-content">
            <h2>Career quide</h2>
            <p>
              The "Career Guide" is an innovative AI system integrated into our
              job search platform, designed to provide personalized career
              recommendations and comprehensive roadmaps to users based on their
              responses to a series of input questions. This feature aims to
              assist job seekers in making informed and strategic decisions
              about their career paths, helping them discover suitable career
              options aligned with their interests, skills, and aspirations.
            </p>
            <p>Read more</p>
          </div>
        </div>
        ...
        <div className="Code-collab">
          <img src="" alt="" />
          <div className="Code-collab-text">
