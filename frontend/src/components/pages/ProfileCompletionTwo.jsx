            ...
            <div className="Profile-completion-two-right">
                ...
                <div className="Profile-completion-two-content">
                    ...
                    <div className="Industry-dropdown">
                        ...
                        <button className="Industry-dropdown-button" onClick={handleIndustryDropdownClick}>
                            <p className="Industry-select-text">Select an industry</p>
                            <img className={`Expand-more ${openIndustry ? 'up' : ''}`} src="pictures/expand-more.png" alt="" />
                        </button>
                        {openIndustry && 
