...
const UrapolkuInfo = () => {
  return (
    <section className="Urapolku-info-container">
      ...
      <p>
        Etsitpä sitten töitä tai haluat löytää uusia työntekijöitä, me tarjoamme
        sinulle innovatiivisen ratkaisun löytää juuri sen mitä etsit: olipa
        kyseessä sitten uusi työpaikka, taitava osaaja, suunnanmuutos,
        unelmatyön tavoittelu tai vaikka kesätyö. Urapolullta löydät suuren
